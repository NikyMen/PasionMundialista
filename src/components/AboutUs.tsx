...
export const AboutUs: React.FC = () => {
  return (
    <section
      id="nosotros"
      className="relative min-h-[calc(100vh-72px)] bg-gray-100"
      style={{
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full flex justify-start">
        <div className="bg-gray-50/95 backdrop-blur-sm text-gray-900 rounded-lg shadow-lg w-full md:max-w-xl p-6 md:p-8">
